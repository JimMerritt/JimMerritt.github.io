...
export default function Home() {
	return (
		<main
			id="main-content"
			className="max-w-5xl py-12 px-16 grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 auto-cols-min"
		>
			...
			<section className="max-w-lg col-start-1" aria-labelledby="contact">
			...
			<section className="max-w-lg md:col-start-2" aria-labelledby="education">
				<h2 id="education">Education</h2>
				<h3>Northern Kentucky University</h3>
				<p>Visual Communications Design</p>
				<p>Minor in Computer Science</p>
			</section>
			<section className="max-w-lg col-start-1" aria-labelledby="skills">
